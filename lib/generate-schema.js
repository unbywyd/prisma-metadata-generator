...
export default async function generateClass(config, project, outputDir, model, mainConfig, foreignKeyMap, refs, enums) {
    ...
    const listPrepared = [];
    const listModels = config.lists ? config.lists : false;
